            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  ...
                  <fieldset className="mt-4">
                    ...
                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                      ...
                      <label className={`group relative flex items-center justify-center rounded-md border py-3 px-4 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6 cursor-pointer bg-white text-gray-900 shadow-sm ${selectedSize === 'XS' ? 'border-indigo-500' : 'border-transparent'}`}
                ...
                <div className="mt-10">
                  <button
                    type="submit"
                    className="group relative w-full flex justify-center py-4 px-6 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M12 8V4a1 1 0 0 0-2 0v4H4a1 1 0 1 0 0 2h6v4a1 1 0 1 0 2 0v-4h6a1 1 0 1 0 0-2h-6z"
                        />
                      </svg>
                    </span>
                    Add to cart
